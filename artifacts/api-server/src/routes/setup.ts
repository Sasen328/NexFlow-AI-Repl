  ...
  try {
    ...
    const [config] = await db.insert(tenant_configs).values({
      ...
      branding: {
        ...
        primaryColor:    answers.primaryColor    ?? "#B8A0C8",
        secondaryColor:  answers.secondaryColor  ?? "#88B8B0",
        accentColor:     answers.accentColor     ?? "#C8A880",
        meshColors:      answers.meshColors      ?? ["#B8A0C8","#88B8B0","#C8A880"],
        brandMode:       answers.brandMode       ?? "pick",
        ...
        seatsSales:      answers.seatsSales      ?? 0,
        seatsSDR:        answers.seatsSDR        ?? 0,
        seatsMarketing:  answers.seatsMarketing  ?? 0,
        seatsManagement: answers.seatsManagement ?? 0,
        currentCrm:      answers.currentCrm      ?? "",
        migrationNeeded: answers.migrationNeeded ?? false,
        supportLevel:    answers.supportLevel    ?? "standard",
        trainingNeeded:  answers.trainingNeeded  ?? false,
