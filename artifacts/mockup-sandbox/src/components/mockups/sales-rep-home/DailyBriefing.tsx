  ...
  async function send() {
    ...
    try {
      ...
      if (autoPublish && data.suggestedTasks?.length) {
        await fetch(`${API}/publish-checklist`, {
          method: "POST",
          headers: { "Content-Type": "application/json" },
      ...
      <div className="flex items-center gap-2">
        ...
        <div className="ml-auto flex items-center gap-1.5">
          <Switch
            ...
            className="scale-75"
          />
          <label htmlFor="auto-pub" className="text-[11px] text-muted-foreground">
...
function AIFullAnalysis({ data, loading, mode, setMode }: { data: Analysis | null; loading: boolean; mode: Mode; setMode: (m: Mode) => void }) {
  return (
      ...
      <CardHeader className="pb-3">
        <div className="flex items-center justify-between gap-2">
          ...
          <Badge variant="outline" className="text-[10px]">
            ...
            {data?._source === "ai" ? "Generated by Claude" : "Cached fallback"}
          </Badge>
        </div>
      </CardHeader>
...
export function DailyBriefing() {
  ...
  return (
    <div className="min-h-screen bg-background p-5">
      <div className="mx-auto max-w-[860px] space-y-3.5">
        ...
        <div className="grid grid-cols-3 gap-3">
          <div className="col-span-2">
            <AIFullAnalysis data={data} loading={loading} mode={mode} setMode={setMode} />
          </div>
