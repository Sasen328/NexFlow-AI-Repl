    ...
    >
            ...
            {[
              ...
              <div
                ...
                style={{
                  ...
                  color: l.active ? "var(--rd-ink)" : "var(--rd-mute)",
                  background: l.active ? "var(--rd-sand-2)" : "transparent",
                }}
              >
      ...
      <div className="flex items-center gap-2.5 px-1.5">
        <div
          ...
          style={{ width: 28, height: 28, borderRadius: 999, background: "var(--rd-accent)", color: "#fff", fontSize: 11, fontWeight: 500 }}
        >SK</div>
...
function ConductorBubble() {
  return (
    <div
      ...
      style={{
        position: "absolute", bottom: 28, right: 32, zIndex: 50,
...
const rows = [
  ...
  { name: "Hala Mansour", co: "Etisalat by e&", title: "CFO", stage: "Proposal", touch: "5d · email", health: 0.49, next: "Send security brief", star: false },
  { name: "Tariq Bensalem", co: "OCP Group", title: "Director Tech", stage: "Discovery", touch: "today · LinkedIn", health: 0.71, next: "Reply with discovery deck", star: false },
];
...
function StageChip({ stage }: { stage: string }) {
  ...
  return (
    <span className="rd-pill" style={{ background: c.bg, color: c.fg, fontWeight: 500 }}>
      {stage}
    </span>
  );
}
      ...
      <main style={{ flex: 1, overflow: "auto" }}>
        ...
        <div style={{ padding: "20px 36px 0 36px" }}>
          <div className="flex items-baseline gap-6" style={{ borderBottom: "1px solid var(--rd-cream)", marginBottom: 18 }}>
            {["People", "Companies", "Deals"].map((t, i) => (
              <div key={t} style={{ paddingBottom: 12, position: "relative", cursor: "pointer" }}>
                <span className="rd-display" style={{ fontSize: 22, color: i === 0 ? "var(--rd-ink)" : "var(--rd-mute-2)" }}>{t}</span>
                {i === 0 && (
                  <div style={{ position: "absolute", bottom: -1, left: 0, right: 0, height: 2, background: "var(--rd-accent)" }} />
                )}
              </div>
            ))}
          ...
          <div className="flex items-center gap-2 mb-4">
            {[
              ...
              <span
                ...
                className="rd-pill"
                style={{
                  background: c.on ? "var(--rd-ink)" : "transparent",
                  color: c.on ? "var(--rd-sand)" : "var(--rd-mute)",
                  border: c.on ? "0" : "1px solid var(--rd-cream)",
        ...
        <div style={{ padding: "0 36px 100px 36px" }}>
          <div className="rd-card" style={{ overflow: "hidden" }}>
            ...
            <div
              ...
              style={{
                gridTemplateColumns: "24px 2fr 1.5fr 1.2fr 1.4fr 1fr 1.6fr",
                padding: "10px 16px",
                fontSize: 11, color: "var(--rd-mute)", textTransform: "uppercase", letterSpacing: "0.05em",
                borderBottom: "1px solid var(--rd-cream)",
              }}
            >
              <span></span>
              <span>Person</span>
            ...
            {rows.map((r, i) => (
              <div
                ...
                style={{
                  gridTemplateColumns: "24px 2fr 1.5fr 1.2fr 1.4fr 1fr 1.6fr",
                  padding: "11px 16px",
                  borderBottom: i < rows.length - 1 ? "1px solid var(--rd-cream)" : "none",
                  background: i === 0 ? "var(--rd-sand-2)" : "transparent",
                  cursor: "pointer",
                }}
              >
                ...
                <div className="flex items-center gap-2.5">
                  <div
                    className="flex items-center justify-center"
                    style={{ width: 26, height: 26, borderRadius: 999, background: "var(--rd-cream)", color: "var(--rd-ink-2)", fontSize: 10.5, fontWeight: 500 }}
                  >
          ...
          <div className="flex items-center justify-between mt-3" style={{ fontSize: 11, color: "var(--rd-mute)" }}>
            <span>Showing 9 of 23 · click any row to open the drawer</span>
