    ...
    <div className="relative w-screen h-screen overflow-hidden bg-bg text-ink font-body">
      ...
      <div className="absolute left-[6vw] bottom-[16vh] right-[6vw]">
        <div className="text-[1.15vw] tracking-[0.3em] uppercase font-semibold text-ink/70 mb-[3vh]">
          The first GCC-native AI CRM
        </div>
        <h1 className="font-display font-extrabold text-[10vw] leading-[0.92] tracking-[-0.03em] [text-wrap:balance]">
          Where revenue<br />learns to flow.
        </h1>
        <p className="mt-[4vh] font-serif italic text-[2.1vw] leading-snug max-w-[60vw] text-ink/80 [text-wrap:pretty]">
          A sovereign CRM platform engineered for Saudi Arabia and the wider Gulf — bilingual at its core, AI-native, and built around how teams actually sell here.
        </p>
      </div>
      ...
      <div className="absolute bottom-[6vh] left-[6vw] right-[6vw] flex items-end justify-between text-[0.95vw] tracking-[0.22em] uppercase font-semibold text-ink/65">
        ...
        <span>Confidential — design-partner & investor use</span>
      </div>
    </div>
  );
}
